...
################################################################################
# Genova AI Backend - Develop Service Deployment
#
# This script deploys the backend to the dedicated Cloud Run service
# `genova-ai-backend-develop` using Cloud Build.
#
...
SERVICE_NAME="genova-ai-backend-develop"
BUILD_CONFIG="cloudbuild-develop-service.yaml"

echo -e "${GREEN}╔════════════════════════════════════════════════════════════╗${NC}"
echo -e "${GREEN}║    Genova AI Backend - Develop Service Deployment         ║${NC}"
echo -e "${GREEN}╚════════════════════════════════════════════════════════════╝${NC}"
echo ""
...
echo ""
gcloud builds submit .. --config="backend/$BUILD_CONFIG" --project="$PROJECT_ID"
echo ""
